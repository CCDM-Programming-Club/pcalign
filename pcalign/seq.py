""" The seq module contains all classes and functions for parsing
manipulating and writing FASTA formatted sequences.
"""
...
class Seq(object):
    ...
    """
    Seq is a class to parsing, containing and manipulating FASTA formatted
    ...
    def __init__(self, id, desc, seq):
        ...
        logger.debug("Constructed " + repr(self))
        return
